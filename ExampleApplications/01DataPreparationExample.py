...
Eval_df.to_csv(f"Eval_{cellsize}{suffix}.csv", index=False)
...
if cellsize == "50m":
    ...
    grid_dataframe = create_traffic_emission_columns(df = grid_dataframe, id = "int_id", TrV_coeff =  2.845e-02 , TrI_coeff = 1.072e-04, suffix=cellsize + suffix)
    ...
    grid_dataframe.loc[grid_dataframe["baseline_NO2"] < 0, "baseline_NO2"] = 0
    grid_dataframe = create_traffic_emission_columns(df = grid_dataframe, id = "int_id", TrV_coeff = 1.586e-02 , TrI_coeff = 1.306e-04, suffix=cellsize + suffix)
    

#########################################################
#### Adding Road Neighbors indicator to Pred_df #########
#########################################################
